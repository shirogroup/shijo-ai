...
export const PRICING_PLANS: PricingPlan[] = [
  {
    ...
    geo: '1 AI visibility scan per day — results are not saved',
    features: [
  ...
  },
  {
    ...
    geo: '30 saved AI visibility scans per month',
    features: [
      'All 12 AI marketing tools',
      '200 generations per month',
      'Saved scan history, score trend and CSV export',
    ],
  ...
  },
  {
    ...
    geo: '100 saved AI visibility scans per month',
    features: [
      'All 12 AI marketing tools',
      '200 generations per month',
      'Track up to 3 businesses',
    ],
  ...
  },
  {
    ...
    geo: '300 saved AI visibility scans per month — the highest allowance',
    features: [
      'All 12 AI marketing tools',
